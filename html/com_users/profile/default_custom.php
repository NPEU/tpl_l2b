...
<?php endif;*/ ?>
<section>
    <dl  class="l-layout  l-row  l-gutter  l-flush-edge-gutter  u-space--below user-profile">
        ...
        <span class="l-layout  l-gallery-grid  l-gallery-grid--gutter--s  l-gallery-grid--basis-15" role="list">

            <?php foreach($field->value as $brand_id) :
                $brand = TplL2BHelper::get_brand($brand_id);
                ...
                $svg_info = TplL2BHelper::svg_info($svg_path);
