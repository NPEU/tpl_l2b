...
$menu_item = TplL2BHelper::get_menu_item();
$menu_item_params = $menu_item->getParams();
?>

<div class="l-layout  page-wrap" data-brand="">

    <?php if ($env != 'production') : ?>
    <div class="env_container" id="env_container">
        <div>
            <fieldset role="presentation">
                ...
                <button id="env-msg-close-button" aria-labelledby="env-msg-close-button-label" onclick="this.parentNode.parentNode.parentNode.style.display='none'">
                    <?php echo BlocksHelper::renderUse('x', [], null, '<text visibility="hidden" id="env-msg-close-button-label">Close this notice</text>'); ?>
                </button>
            </fieldset>
        </div>
    </div>
    ...
    <div class="l-box">
        ...
        <header class="page-header">
            <div class="l-layout  l-row  l-row--push-apart  l-gutter--s  l-flush-block-gutter  d-background">
                <div class="l-box">
                ...
                <div class="l-box">
                    <?php /*<p role="list" class="c-utilitext">
                        <span role="listitem">
            ...
            <div class="l-layout  l-row  l-gutter  d-background  page-header__main"  data-fs-text="center">
                <p class="l-box  page-header__logo">
                    <a href="/" class="c-badge  c-badge--primary-logo">
                ...
                <p class="l-box  page-header__cta">
                    <span class="l-layout  l-row  l-gutter  l-flush-edge-gutter">
                        <?php if ($isGuest) : ?>
                        <span class="l-box">
                            <a href="/register" data-fs-block="inline border padding" class="c-cta"><span><?php echo BlocksHelper::renderUse('user'); ?></span><span class="u-separator">&nbsp;</span><span>Register for the Toolkit</span></a>
                        </span>
                        <?php endif; ?>
                        <span class="l-box">
                            <a href="/implementing-the-listen2baby-toolkit" data-fs-block="inline border padding" class="c-cta"><span><?php echo BlocksHelper::renderUse('box'); ?></span><span class="u-separator">&nbsp;</span><span>Access the Toolkit</span></a>
                        </span>
                    </span>
                </p>
            </div>
    ...
    <div class="l-box  l-box--expand">
        ...
        <main id="main" aria-labelledby="<?php echo TplL2BHelper::html_id($page_heading); ?>" class="">
            <?php if ($page_has_hero) : ?>
            <div class="c-hero">
                <p class="c-hero__image"><img src="/images/hero/listen-to-baby-hero.jpg" alt=""></p>
                <p class="c-hero__heading"><?php echo $page_hero->hero_text; ?></p>
            </div>
            <?php if ($page_hero->credit) : ?>
            <div>
                <p class="l-layout  l-row  l-row--end">
                    <span class="l-box  l-box--space--inline">
                        <i class="c-utilitext"><?php echo trim(TplL2BHelper::tweak_markdown_output(Markdown::defaultTransform($page_hero->credit),['trim_paragraph' => true, 'add_link_spans' => true])); ?></i>
                    </span>
                </p>
            </div>
            <?php endif; ?>
            ...
            <div class="l-box  l-box--space--block-start--l  elastipad">
                <h1 class="l-box  l-box--space--inline"><?php echo $page_heading; ?></h1>
            </div>
            <?php endif; ?>
