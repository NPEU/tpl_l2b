...
<div class="password-group">
    <div class="input-group">
        ...
        <button type="button" class="btn btn-secondary input-password-toggle">
            <svg width="1.25em" height="1.25em" aria-hidden="true" focusable="false" display="inline"><use href="#blocksicon-eye"></use></svg>
            <span data-hidden="visually"><?php echo Text::_('JSHOWPASSWORD'); ?></span>
        </button>
        <?php else : ?>
