...
<form action="<?php echo Route::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="user-form">
    <fieldset>
        ...
        <div class="l-layout  l-row  l-row--start">
            ...
            <div class="l-box  ff-width-100--25--70">
                <span>
                    <button type="submit"><span>Send reminder</span></button>
                </span>
            </div>
        </div>
